...
void mmu_destroy_context(mmu_context_t *ctx); // Warning! Do not use referance after calling this
...
void mmu_barrier();
void mmu_flush_tlb(); // flushes all tlb
void mmu_flush_tlb_range(uint64_t va, size_t lenght); // flushes range
